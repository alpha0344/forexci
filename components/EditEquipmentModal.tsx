  ...
  useEffect(() => {
    if (equipment && isOpen) {
      setFormData({
        ...
        lastVerificationDate: formatDateForInput(equipment.lastVerificationDate),
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-xs text-blue-700">
                Validité: {equipment.material.validityTime} jours - 
                Contrôle tous les {equipment.material.timeBeforeControl} jours
                {equipment.material.timeBeforeReload && ` - Recharge tous les ${equipment.material.timeBeforeReload} jours`}
              </p>
            </div>
