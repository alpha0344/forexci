  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "brand-gradient":
          "linear-gradient(135deg, #E63946 0%, #F77F00 50%, #1D3557 100%)",
        "brand-gradient-subtle":
          "linear-gradient(135deg, #F8F9FA 0%, #EDF2F4 50%, #F8F9FA 100%)",
        "brand-gradient-card":
          "linear-gradient(135deg, #F8F9FA 0%, #EDF2F4 100%)",
        "brand-gradient-hero":
          "linear-gradient(135deg, #2B2D42 0%, #1D3557 100%)",
      },
      boxShadow: {
        "brand-red":
          "0 10px 15px -3px rgba(230, 57, 70, 0.15), 0 4px 6px -4px rgba(230, 57, 70, 0.1)",
        "brand-orange":
          "0 10px 15px -3px rgba(247, 127, 0, 0.15), 0 4px 6px -4px rgba(247, 127, 0, 0.1)",
        "brand-blue":
          "0 10px 15px -3px rgba(29, 53, 87, 0.15), 0 4px 6px -4px rgba(29, 53, 87, 0.1)",
      },
      animation: {
